  ...
  return {
    ...
    [UI]: (
      <div style={{ fontFamily: "system-ui", lineHeight: "1.6" }}>
        ...
        <div style={{ opacity: "0.7", fontSize: "0.85em" }}>
          The character you type always appears at once. The derived values above
          update in realtime as you type normally, and throttle to about one
          update per second only under sustained fast typing — the latest value
          always arrives.
        </div>
      </div>
    ),
