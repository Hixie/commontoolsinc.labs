...
async function main() {
  ...
  // Asked per PATTERN rather than of the whole list, because a lane checks only
  // the patterns it was given. Only the run that examined a pattern can say
  // whether its pairs were needed, and the runs of one commit between them
  // examine every pattern.
  //
